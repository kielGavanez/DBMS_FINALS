...
<body>
    ...
    <h1 class="text-3xl">{{$event->eventName}}</h1>
    <h5>Event Code: {{$event->id}}</h5>  
    <p>{{$event->date}}</p>
    <p>{{$event->location}}</p>
    ...
    <table class="table-auto m-auto border-solid border-2 border-gray-200 mt-10">
        <thead class="border-solid border-2 border-gray-200">
            <tr>
                <th class="border-solid border-2 border-gray-200 w-96 text-center p-2">Event Id</th>
                <th class="border-solid border-2 border-gray-200 w-96 text-center p-2">Event Attendee</th>
